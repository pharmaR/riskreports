...
params:
  ...
  source: "pgk_install"
  r_validation_logo_path: "r_validation_logo.png"  # Default logo path
  logo_path: "r_validation_logo.png"  # Default logo path
  logo_path_dark: "r_validation_logo.png"  # Default logo path
  primary_color: "#4d8dc9;"           # Default primary color (blue)
  secondary_color: "#68b8e5;"
...
format:
  html: 
    ...
    include-after-body: ["transform_pre_class.html", "footer.html"]
    theme: 
...
```{r branding, include=FALSE}
# Load YAML package and read the branding config
library(yaml)
brand <- yaml::read_yaml(params$brand_path)

# Select logo images based on theme (light/dark)
logo_img <- brand$logo$images[[brand$logo$medium$light]]
logo_img_dark <- brand$logo$images[[brand$logo$medium$dark]]
logo_icon <- brand$logo$images[[brand$logo$small]]
logo_full <- brand$logo$images[[brand$logo$large]]
```

<!-- Brand Logo Section (supports light/dark mode if needed) -->
<div style="display: flex; align-items: center; gap: 1em;">
  <img src="`r logo_img`" style="height:60px;" alt="Brand Logo (Light)">
  <img src="`r logo_img_dark`" style="height:60px; display:none;" alt="Brand Logo (Dark)">
</div>

<!-- Optionally add icon/full logo elsewhere -->
<!-- <img src="`r logo_icon`" style="height:40px;" alt="Brand Icon"> -->
<!-- <img src="`r logo_full`" style="height:80px;" alt="Brand Full Logo"> -->

<!--
::: {.content-visible when-format="pdf"}
#figure(image("`r params$logo_path`", width: 50%), caption: "Logo")
:::
 -->
...
::: {.content-visible when-format="pdf"}
#figure(image("`r params$r_validation_logo_path`", width: 30%), caption: "Generated by R-Validation Hub workflow")
:::

<!-- 
 ```{r results="asis",fig.align="center"}
cat(sprintf('![](%s){width=50%%}', logo_img))
 ```
-->
...
<div style="text-align: center; margin: 0 auto;">
  ...
  <p style="margin-top: 10px;">Generated by R-Validation Hub workflow</p>
</div>
', logo_img))
 ```