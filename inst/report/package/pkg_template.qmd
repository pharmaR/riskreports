...
# NOTE: This code is commented because it is making the lua colapsible filter not to work
library("knitr")
library("riskreports")
...
The advantage of the lua filter is that the code is printed exactly as in the R console
-->
