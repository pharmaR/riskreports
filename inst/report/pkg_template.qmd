  ...
  columns = list(
    ...
    Values = reactable::colDef(
      ...
      cell = function(value) {
        if (value ==  "Yes") {
          # Green 'Yes'
          htmltools::span(value, style = "color: #00d26a; font-weight: bold;")
        } else if (value == "No") {
          # Red 'No'
          htmltools::span(value, style = "color: red; font-weight: bold;")
        } else {
          htmltools::span(value, style = "color: #1a1826; font-weight: bold;")
        }
      },
      align = "center"
    )
