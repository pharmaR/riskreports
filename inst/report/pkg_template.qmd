---
title: "Validation Report - `r params$package_name` v `r params$pacakge_version`"
date: "`r Sys.time()`"
...
library("knitr")
knit_hooks$set(showDetails = function(before, options, envir, summary) {
  if (before) {
    str <- "<details>\n"
    paste0(str, "<summary>", summary,"</summary>\n")
    return()
  } else {
    return("\n</details>")
  }
