...
```{r}
#| eval: false
checks <- check_packages_in_dir("source")
```
...
```{r}
details_source <- check_packages_in_dir_details(dir = "source/", full = TRUE)
details_manual <- check_packages_in_dir_details(dir = "checks/", full = TRUE)
...
```{r}
summarize_check_packages_in_dir_results("source/", full = TRUE)
summarize_check_packages_in_dir_timings("source/", full = TRUE)
